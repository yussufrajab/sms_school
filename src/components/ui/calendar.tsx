  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-indigo-50 [&:has([aria-selected].day-outside)]:bg-indigo-50/50",
          props.mode === "range"
        ...
        outside:
          "day-outside text-slate-400 aria-selected:bg-indigo-50/50 aria-selected:text-slate-400",
